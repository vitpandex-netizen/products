# Hermes Web UI — Веб-интерфейс для Hermes Agent

[English version below]

---

Hermes WebUI — это легковесный веб-интерфейс для [Hermes Agent](https://hermes-agent.nousresearch.com/).
Полная parity с CLI-опытом: всё, что можно сделать из терминала, можно сделать из этого UI.
Без шага сборки, без фреймворка, без бандлера. Просто Python и vanilla JS.

**Трёхпанельная компоновка:** левая боковая панель для сессий и навигации, центр — чат,
правая — обзор рабочего пространства. Выбор модели, профиля и рабочего пространства —
в **composer footer** (всегда виден при наборе). Круговой индикатор context ring показывает
использование токенов. Все настройки и инструменты сессий — в **Hermes Control Center**.
